...
public class RetrieveMinTempWeatherStationsRedAlert extends Command {

    public RetrieveMinTempWeatherStationsRedAlert(String host, String basePath, String command) {
    ...
    public String console() {
        return "Station # Red Alerts";// + getFullPath();
    }
