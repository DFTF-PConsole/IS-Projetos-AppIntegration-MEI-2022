...
public class RetrieveTempReadingsStandardWeatherEventsLocation extends Command {

    public RetrieveTempReadingsStandardWeatherEventsLocation(String host, String basePath, String command) {
    ...
    public String console() {
        return "Location # Temperature readings";// + getFullPath();
    }
