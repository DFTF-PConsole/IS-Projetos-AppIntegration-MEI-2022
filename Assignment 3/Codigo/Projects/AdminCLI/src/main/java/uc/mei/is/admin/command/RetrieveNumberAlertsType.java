...
public class RetrieveNumberAlertsType extends Command {

    public RetrieveNumberAlertsType(String host, String basePath, String command) {
    ...
    public String console() {
        return "Type # Alerts";// + getFullPath();
    }
