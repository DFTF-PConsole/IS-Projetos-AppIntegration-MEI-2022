...
public class RetrieveMinMaxTempLocation extends Command {

    public RetrieveMinMaxTempLocation(String host, String basePath, String command) {
    ...
    public String console() {
        return "Station # MinMax Temps";// + getFullPath();
    }
